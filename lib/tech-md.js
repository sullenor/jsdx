...
/**
 * Если есть файлик с документацией, то считывает его и парсит.
 *
 * @param  {object}  target
 * @return {promise}
 */
 ...
 *
 * @todo   Отказаться от функции Resolve в пользу обычных путей.
...
module.exports = function (block, config) {
    ...
    stack.push(attachFile(ast, block).then(processFile));
